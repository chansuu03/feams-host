...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <?php else: ?>
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <strong><a class="nav-link" style="color: white;" href="<?= base_url();?>/logout">logout</a></strong>
        </li>
      </ul>
    <?php endif ?>
  </div>
...
<div class="container-fluid bg-dark" style="color: white;">
  <span class="text-center" style="width: 100%; display:block;">Copyright &copy; 2021 <a href="#" data-toggle="modal" data-target="#developerModal">Data Driven Squad</a> || All rights
        reserved. </span>
</div>
<?= view('devmodal')?>
<?= $this->endSection() ?>
